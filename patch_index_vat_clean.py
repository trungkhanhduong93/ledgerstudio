...
def patch():
    ...
    # 12b. Close div for signature block
    target12b = '</div>\n                            </div>\n\n                            {/* Floating Action Buttons */}'
    replacement12b = '</div>\n                            </div>\n                            )}\n\n                            {/* Floating Action Buttons */}'
    assert target12b in content, "target12b not found"
    content = content.replace(target12b, replacement12b, 1)
